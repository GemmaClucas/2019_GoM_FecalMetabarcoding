...
FOO_MON_ADULT_MIX <- do_everything2("Monomoy NWR", "ADULT", "Mixed") %>% 
  mutate(Colony = "Monomoy NWR", Age = "ADULT", Period = "Mixed")

FOO_SEA_ADULT_INC <- do_everything2("White and Seavey Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "White and Seavey Is.", Age = "ADULT", Period = "Incubation")

FOO_SEA_ADULT_CHR <- do_everything2("White and Seavey Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "White and Seavey Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_STI_ADULT_INC <- do_everything2("Stratton Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Stratton Is.", Age = "ADULT", Period = "Incubation")

FOO_STI_ADULT_CHR <- do_everything2("Stratton Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Stratton Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_OGI_ADULT_INC <- do_everything2("Outer Green Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Outer Green Is.", Age = "ADULT", Period = "Incubation")

FOO_OGI_ADULT_CHR <- do_everything2("Outer Green Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Outer Green Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_JEN_ADULT_INC <- do_everything2("Jenny Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Jenny Is.", Age = "ADULT", Period = "Incubation")

FOO_JEN_ADULT_CHR <- do_everything2("Jenny Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Jenny Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_PON_ADULT_INC <- do_everything2("Pond Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Pond Is.", Age = "ADULT", Period = "Incubation")

FOO_PON_ADULT_CHR <- do_everything2("Pond Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Pond Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_EGG_ADULT_INC <- do_everything2("Eastern Egg Rock", "ADULT", "incubation") %>% 
  mutate(Colony = "Eastern Egg Rock", Age = "ADULT", Period = "Incubation")

FOO_EGG_ADULT_CHR <- do_everything2("Eastern Egg Rock", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Eastern Egg Rock", Age = "ADULT", Period = "Chick-rearing")

FOO_MET_ADULT_INC <- do_everything2("Metinic", "ADULT", "incubation") %>% 
  mutate(Colony = "Metinic", Age = "ADULT", Period = "Incubation")

FOO_MET_ADULT_CHR <- do_everything2("Metinic", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Metinic", Age = "ADULT", Period = "Chick-rearing")

FOO_SINWR_ADULT_INC <- do_everything2("Seal Is. NWR", "ADULT", "incubation") %>% 
  mutate(Colony = "Seal Is. NWR", Age = "ADULT", Period = "Incubation")

FOO_SINWR_ADULT_CHR <- do_everything2("Seal Is. NWR", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Seal Is. NWR", Age = "ADULT", Period = "Chick-rearing")

FOO_SHI_ADULT_INC <- do_everything2("Ship Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Ship Is.", Age = "ADULT", Period = "Incubation")

FOO_SHI_ADULT_CHR <- do_everything2("Ship Is.", "ADULT", "chick-rearing") %>% 
  mutate(Colony = "Ship Is.", Age = "ADULT", Period = "Chick-rearing")

FOO_PMI_ADULT_INC <- do_everything2("Petit Manan Is.", "ADULT", "incubation") %>% 
  mutate(Colony = "Petit Manan Is.", Age = "ADULT", Period = "Incubation")

FOO_PMI_ADULT_CHR <- do_everything2("Petit Manan Is.", "ADULT", "chick-rearing") %>% 
