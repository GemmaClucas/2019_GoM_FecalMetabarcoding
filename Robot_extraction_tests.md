...
Using Jaccard distances:
    ...
    qiime diversity beta \
      ...
      --p-metric jaccard \
      --p-n-jobs 4 \
      --o-distance-matrix jaccardmatrix_rarefied400.qza
      
    qiime diversity pcoa \
      --i-distance-matrix jaccardmatrix_rarefied400.qza \
      --o-pcoa pcoa_rarefied400.qza
      
    qiime emperor plot \
      --i-pcoa pcoa_rarefied400.qza \
        --m-metadata-file metadata.txt \
        --o-visualization emperorplot_rarefied400
...
significant (pseudo-F = 3.713, p \< 0.001). I’m not sure how meaningful
...
Do the same but using Bray-Curtis differences.
    ...
    qiime diversity beta \
      ...
      --p-metric braycurtis \
      --p-n-jobs 4 \
      --o-distance-matrix braycurtis_rarefied400.qza
      
    qiime diversity pcoa \
      --i-distance-matrix braycurtis_rarefied400.qza \
      --o-pcoa pcoa_braycurtis_rarefied400.qza
      
    qiime emperor plot \
      --i-pcoa pcoa_braycurtis_rarefied400.qza \
        --m-metadata-file metadata.txt \
        --o-visualization emperorplot_braycurtis_rarefied400
...
PERMANOVA is not significant (pseudo-F = 0.847, p = 0.539).
